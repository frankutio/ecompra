...
<table width="100%" align="center">
  ...
  <tr class="fonteItenMenu">
    ...
    <td height="35">Nome:
    <input name="txt_nome_produto" type="text" value="" size="40" /></td>
    <td>Fabricante:
    <input name="txt_fabricante" type="text" value="" /></td>
  </tr>
  <tr align="center">
    <td height="35" colspan="3">
        <a href="/ecompra/ProdutoServlet?operacao=pesquisar_produtos">
...
<c:forEach items="${buscar_produtos}" var="buscar_produtos">
    <tr>
        ...
        <td align="center"><a href="/ecompra/#" class="setaLink"><img src="/ecompra/public/image/icones/ic_excluir.gif" class="setaLink" title="Excluir" /></a></td>
    </tr>
</c:forEach>

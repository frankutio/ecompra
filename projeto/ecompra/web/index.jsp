...
<body class="body">
    <form method="post" action="trab_diplomacao">
        <div id="topo">&nbsp;
            <div id="carrinho">
                <a href="#" class="setaLink"><img src="/ecompra/public/image/icones/ic_carrinho.gif" border="0" /><span class="texto_opcoes">Meu carrinho</span></a>
            </div>
            <div id="cadastro">
                <a href="cliente_cadastro.html"  class="setaLink"><img src="/ecompra/public/image/icones/ic_cadastro.gif" border="0" /><span class="texto_opcoes" >Cadastre-se aqui!</span></a>
            </div>
            <div id="login">
                <a href="cliente_login.html" class="setaLink"><img src="/ecompra/public/image/icones/ic_login.gif" border="0"/><span class="texto_opcoes">Login</span></a>
            </div>
        </div>
        ...
        <div id="logo">
            <a href="index.html"><img src="/ecompra/public/image/logo3.gif" border="0" title="Retornar para a loja!" class="setaLink"  /></a>
        </div>
        ...
        <div id="conteudo">
            <table width="100%" border="0">
                ...
                <tr align="center">
                    <td><img src="/ecompra/public/image/produtos/img_005.gif" width="130" height="107" /></td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                </tr>

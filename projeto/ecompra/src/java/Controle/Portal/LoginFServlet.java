...
public class LoginFServlet extends HttpServlet {

    public LoginFServlet() {
        super();
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (usuarioLogado != null) {
            ...
            response.sendRedirect("/ecompra/cliente_endereco_entrega.jsp");
        } else {
            request.getSession().setAttribute("msgError", Mensagens.msgErroLogin);
            response.sendRedirect("/ecompra/Cliente/cliente_logiin.jsp");
        }

...
/*		if(instancia==null){
	...
	protected void montaTela() {
		...
		usuariosCadastrados = UsuarioDao.getInstancia().getListaUsuarios();
		int totalLinhasTela ;
	...
	public void actionPerformed(ActionEvent arg0) {
		if( arg0.getActionCommand().equals("voltar") ){
			...
			ClienteBean userAcao = UsuarioDao.getInstancia().getUsuario( Integer.parseInt( arg0.getActionCommand().substring(1) ) );
			/*if( arg0.getActionCommand().substring(0, 1).equals("a") ){//alteracao
				...
				if( JOptionPane.showConfirmDialog(	this, "Confirma exclusao de '"+userAcao.getNome()+"'?",
					...
					UsuarioDao.getInstancia().exclui(userAcao.getCpf());
					this.esconde();
